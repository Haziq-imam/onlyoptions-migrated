        ...
        items: [
            {
                ...
                answer: "Basic plan: $60 per month. Annual plan: $499.99 per year (equivalent to ~$41.66 per month — Includes SMS & Priority features). All plans provide full Premium Access with flexible membership options."
            },
            {
            ...
            },
            {
                ...
                answer: "Both plans receive the same live signals through the app. Annual adds: SMS text message delivery of every signal, priority email support with a 1-hour response during market hours (versus 24 hours on Basic), and access to weekly live Q&A sessions with the analyst team. If app push notifications are sufficient and you do not need SMS or Q&A access, Basic is strong value."
            },
            {
                question: "Q36. Is the Annual plan worth it?",
                answer: "The Annual plan costs $499.99/year (equivalent to ~$41.66/month) — over $220 less than 12 months of Basic monthly ($60 × 12 = $720). It includes premium features like SMS delivery and priority support. We recommend starting with a monthly plan and upgrading to Annual once you have experienced the performance of the service."
            },
            {
            ...
            },
            {
                ...
                answer: "The Annual plan ($499.99/year) is our best-value pricing — equivalent to ~$41.66/month versus $60 for Basic monthly. We do not offer student, group, or promotional discounts beyond the Annual plan. For affiliate or partnership inquiries, contact partnerships@onlyoptions.us."
            }
        ]
    },
    {
