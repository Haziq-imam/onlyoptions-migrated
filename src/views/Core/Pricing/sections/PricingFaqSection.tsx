...
const PricingFaqSection = () => {
    const faqData = [
        ...
        },
        {
            ...
            a: "The Basic plan ($60/month) and Annual plan ($499.99/year) both receive the same live options signals through the iOS and Android app. The difference is in delivery and support. Annual adds SMS text message delivery of every signal, a 1-hour priority email support response during market hours (versus 24 hours on Basic), and access to weekly live Q&A sessions with the analyst team. If push notifications through the app are sufficient for your workflow and you do not need SMS or live Q&A access, Basic is a strong choice."
        },
        {
            q: "Is the Annual plan worth it?",
            a: "The Annual plan costs $499.99 per year, which is equivalent to ~$41.66 per month — a saving of over $220 per year compared to Basic monthly ($60/month). It includes premium features like SMS delivery and priority support. The Annual plan is ideal for members who are confident in the service long-term. It also locks in your current price for 12 months regardless of any future price changes. We recommend starting with the monthly plan first, then switching to Annual once you have experienced the value of our signals."
        },
        {
        ...
        },
        {
            ...
            a: "Yes. You can upgrade from Basic to Annual at any time from your account dashboard. Billing adjusts pro-rata — you pay only for the difference for the remainder of your current billing period. To change to a lower tier, the change takes effect at your next renewal date. You retain your current plan's features until then."
        },
        {
            q: "Do you offer discounts for students or groups?",
            a: "We do not currently offer student or academic discounts. The Annual plan at $499.99/year is our best-value option for all members. We do not offer group or team pricing at this time."
        }
    ];
