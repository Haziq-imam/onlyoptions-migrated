            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="space-y-24">
                    {sitemapData.map((category, catIdx) => {
                        const validSections = category.sections.map(section => ({
                            ...section,
                            links: section.links.filter(Boolean)
                        ...
                        <div key={catIdx} className="space-y-12">
                            ...
                            <div className={`grid grid-cols-1 ${validSections.length === 1 ? 'lg:grid-cols-1 md:max-w-xl mx-auto' : validSections.length === 2 ? 'lg:grid-cols-2' : 'md:grid-cols-2 lg:grid-cols-3'} gap-12`}>
                                {validSections.map((section, secIdx) => (
