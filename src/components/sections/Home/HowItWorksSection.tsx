...
const steps = [
    { icon: <MdDownload className="w-6 h-6 text-brand-500" />, num: '01', title: 'Create your account', desc: 'Choose a plan and complete signup in under 60 seconds. No credit card required for the free trial.' },
...
const HowItWorksSection = () => (
    <StandardSection className="py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {steps.map((step, i) => (
                <div key={i} className="p-8 rounded-3xl bg-black border border-white/5 hover:border-brand-500/30 transition-all group relative overflow-hidden shadow-xl">
