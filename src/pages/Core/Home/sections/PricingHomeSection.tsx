    ...
    <StandardSection variant="default" divider="top" spacing="lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
            ...
            <Card variant="glass" className="p-10 border-white/5 hover:border-brand-500/20 transition-all group rounded-3xl">
                ...
                <Button href="/membership" variant="outline" className="w-full h-auto min-h-[3.5rem] py-4 rounded-2xl font-black uppercase tracking-widest border-brand-500/30 hover:bg-brand-500/10 text-xs shadow-xl">
                    Get Access
                </Button>
            </Card>
