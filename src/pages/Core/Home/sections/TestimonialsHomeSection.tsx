        ...
        <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 text-left">
                {testimonials.map((t, i) => (
                    <Card key={i} variant="glass" className="p-8 md:p-10 border-white/5 hover:border-brand-500/20 transition-all flex flex-col group min-h-[420px]">
                        ...
                        <div className="pt-8 mt-10 border-t border-white/5">
                            ...
                            <p className="text-gray-400 text-[10px] uppercase font-black tracking-widest mt-2 px-3 py-1 bg-white/5 rounded-lg inline-block">{t.role}</p>
                        </div>
                    </Card>
                ))}
            </div>
            ...
            <div className="mt-20">
                <a href="/testimonials" className="inline-flex items-center gap-2 text-brand-500 text-[10px] font-black uppercase tracking-widest hover:gap-4 transition-all group/link">
                    Read more member results
