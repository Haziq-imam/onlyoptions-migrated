...
const steps = [
    ...
    { icon: <MdNotificationsActive className="w-6 h-6 text-brand-500" />, num: '03', title: 'Enable push notifications', desc: 'Turn on notifications for the app so signals reach you the instant they are sent. Annual plan members can also opt in to SMS delivery.' },
