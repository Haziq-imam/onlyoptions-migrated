        ...
        <StandardSection variant="default" divider="top" spacing="lg">
            <div className="max-w-6xl mx-auto">
                <SectionHeader
                    ...
                    description="Start with the Basic plan if you are unsure. You can upgrade to the Annual plan at any time."
                    align="center"
                    className="mb-20"
                />
                        ...
                        <TableBody>
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: "Confident in the service and want to lock in the lowest per-month rate (~$41/month) based on consistent performance. Prefer one annual payment over monthly billing. Want all premium features including SMS delivery and priority support. Want to guarantee your current price for 12 months regardless of any future price changes."
                                }
                            ].map((item, i) => (
                                <TableRow key={i}>
                ...
                <p className="mt-8 text-[11px] text-gray-500 text-center font-medium">
                    Not sure? Start with the Basic plan. You can upgrade to the Annual plan at any time from your account dashboard.
                </p>
            </div>
        </StandardSection>
    )
