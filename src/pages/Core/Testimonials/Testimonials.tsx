...
const Testimonials = () => {
  ...
  const schemaReviews = [
    ...
    { "@context": "https://schema.org", "@type": "Review", "reviewBody": "The weekly live Q&A on the Annual plan is something I did not think I would use much. Turns out it is one of the most valuable parts of my subscription.", "author": { "@type": "Person", "name": "Priya N." }, "reviewRating": { "@type": "Rating", "ratingValue": "5" } },
    ...
    { "@context": "https://schema.org", "@type": "Review", "reviewBody": "Eight months in. I started with the Basic plan to evaluate before committing to the Annual plan. No complaints.", "author": { "@type": "Person", "name": "Brian T." }, "reviewRating": { "@type": "Rating", "ratingValue": "5" } },
